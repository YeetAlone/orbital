...
//appbar
        ...
        body: Column(children: <Widget>[
          ...
          ElevatedButton.icon(
            ...
            icon: const ImageIcon(AssetImage("assets/name.png"),
          ...
          ElevatedButton.icon(
            ...
            label: const Text("  Find by Building",
                textAlign: TextAlign.left,
                style: TextStyle(
                    color: Color.fromRGBO(0, 105, 92, 1), fontSize: 24)),
            icon: const ImageIcon(AssetImage("assets/building.png"),
                color: Color.fromRGBO(0, 77, 64, 1), size: 45),
          ),
          const SizedBox(height: 20),
          ElevatedButton.icon(
            onPressed: () {},
            ...
            label: const Text(" Find by Availability",
                textAlign: TextAlign.left,
                style: TextStyle(
                    color: Color.fromRGBO(0, 105, 92, 1), fontSize: 24)),
